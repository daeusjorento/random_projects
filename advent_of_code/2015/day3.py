...
pos1 = [0,0] ## (x,y) axis santa
pos2 = [0,0] ## (x,y) axis robot santa
hv1 = [] # house visit locations s
hv2 = [] # house visit locations rs
hv1.append(pos1.copy())
houses = 1
for i,x in enumerate(input):
    #print(x)
    hv = hv1.copy() + hv2.copy() ## won't show final full list, which is fine since thats not the question
    #print(hv)
    #print(houses)
    if(i %2 == 0): # santa
        #print('santa')
